...
Date de derniere modification : 19/10/23
        ...
        do
        {
            ...
            for (iterateur = 1; iterateur <= 5; iterateur++)
            {
                ...
                case 6:
                    ...
                    if (verifBateau == true && verifCapitaine == true && verifEquipage == true) /*VERIFICATION QUE LE BATEAU, LE CAPITAINE ET L'EQUIPAGE ON DEJA ETE TIRE
