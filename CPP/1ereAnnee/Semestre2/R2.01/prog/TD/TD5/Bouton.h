...
private:
    bool m_estActif;
    void dessinerEtat(Fenetre &f) const;
public:
    ...
    void definir(int x, int y, int r, int rouge, int vert, int bleu, bool etat = false);
    ...
    void definir(int x, int y, int r, const Couleur &couleur = Couleur(0, 0, 255), bool etat = false);
