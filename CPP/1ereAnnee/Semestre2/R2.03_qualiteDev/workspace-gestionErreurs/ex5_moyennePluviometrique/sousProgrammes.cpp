...
void calculMoyenneSimple (string nomSysPluvio)
{
    ...
    // nomSysPluvio, moyenne, nbre >> affichage ecran >> (ecran)
    cout << "Fichier " << nomSysPluvio << " : " << endl;
...
/*  Utilisation de le fonction de conversion string to_string(int) et string to_string(float)
    qui transforme un entier en chaîne de caractères.

    Exemple : 
    ligne = "Le fichier comporte " + std::to_string(nbre) + " releves.";
*/
