...
----------------------------- */
void recherchePremiereOccDec  (const Personne tab[],
                            unsigned int lgTab,
                            string val,
                            unsigned int& pos,
                            bool& trouve);
/* But : étant donnés val, une variable chaîne de caractères et le tableau tab, de lgTab cases de type Personne, 
       ordonné par ordre décroissant selon le champ nom,  éventuellement avec doublons,
...
void recherchePremiereOccDec (const Personne tab[],
                            ...
                            bool& trouve)
{
    int bInf;  // borne inferieure de l'espace de recherche, calculee
    int bSup;  // borne inferieure de l'espace de recherche, calculee
